...
public class Preferences {
    ...
    public static final String API_END_TOKEN = "API_TOKEN";
    public static final String API_END_QUOTE_ID = "QUOTE_ID";
    public static final String API_END_CART_ITEM = "CART_ITEM";
    public static final String API_BASE_URL_CONFIG = "API_BASE_URL";
