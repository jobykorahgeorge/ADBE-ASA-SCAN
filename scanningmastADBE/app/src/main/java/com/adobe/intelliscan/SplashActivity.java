...
public class SplashActivity extends Activity {
    ...
    private boolean isAppConfigGood() {
        ...
        String baseurlMagento = preferences.getData(Preferences.API_BASE_URL_CONFIG);
        String username = preferences.getData(Preferences.USER_NAME);
        String password = preferences.getData(Preferences.PASSWORD);
        ...
        if (scanMode == null || scanMode.isEmpty()) {
            ...
            return false;
                ...
                || prodOnePath == null || prodOnePath.isEmpty() || baseurlMagento.isEmpty() || baseurlMagento == null
                 || username == null ||  password == null
            /*|| prodTwoPath == null || prodTwoPath.isEmpty()*/) {
            Toast.makeText(this, "Please configure all fields.", Toast.LENGTH_SHORT).show();
            return false;
        }
