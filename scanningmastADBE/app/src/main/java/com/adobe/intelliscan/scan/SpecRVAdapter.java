...
public class SpecRVAdapter extends RecyclerView.Adapter<SpecRVAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if(spec.contains(":")){
            ...
            holder.mSpecText1.setText(specArray[0].toUpperCase());
            holder.mValueText.setText(specArray[1]);
        }
...
//
//            holder.mSpecText1.setText(spec.substring(1));
...
//            holder.separatorView.setVisibility(View.VISIBLE);
//
//            holder.mValueText.setText(spec);
//        }
    }
